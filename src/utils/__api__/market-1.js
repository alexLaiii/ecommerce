...
const getNewArrivalList = async () => {
  const response = await axios.get("http://localhost:8080/api/products/newArrival");
  return response.data;
};

const getMainCarousel = async () => {
  const response = await axios.get("http://localhost:8080/api/products/main-carousel");
  return response.data;
}

const getFlashDeals = async () => {
  const response = await axios.get("http://localhost:8080/api/products/flash-deals");
  return response.data
}

// this is local images //
const getTopCategories = async () => {
  const response = await axios.get("http://localhost:8080/api/products/top-categories");
  return response.data;
}
// **** //
...
const getBigDiscountList = async () => {
  const response = await axios.get("http://localhost:8080/api/products/big-discounts");
  return response.data;
};

const getTopRatedProduct = async () => {
  const response = await axios.get("http://localhost:8080/api/products/toprated-product");
  return response.data;
};

const getCarList = async () => {
  const response = await axios.get("http://localhost:8080/api/products/cars");
  return response.data;
};

const getMobileList = async () => {
  const response = await axios.get("http://localhost:8080/api/products/mobiles");
  return response.data;
};

const getOpticsList = async () => {
  const response = await axios.get("http://localhost:8080/api/products/optics");
  return response.data;
};

const getCategories = async () => {
  const response = await axios.get("http://localhost:8080/api/products/bottom-categories");
  return response.data;
};

const getMoreItems = async () => {
  const response = await axios.get("http://localhost:8080/api/products/get-more-items");
  return response.data;
};
